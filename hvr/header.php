...
<div align="left" style="height:70px; width:350px; background:
#000000; font-family:'Palatino Linotype', 'Book Antiqua', Palatino, serif; padding-left:100px; padding-top:10px; font-size:32px; color:#FFFFFF;">Title</div></td>
</div></td>
    <td width="10%">
...
<Table width="100%">
  ...
  ?>
	...
	{
	 echo "<div align=\"center\" style='font-size:20px;'><strong><a href=\"home.php\"> Home </a>|<a href=\"signout.php\">Signout</a></strong></div>";
	 }
	 else
	 {
	 	echo "&nbsp;";
