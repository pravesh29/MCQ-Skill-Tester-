...
<div align=\"center\" style='font-size:16px;'><strong style="float:right;"  style="margin-top:-60px;"><a href="admin.php"> Admin Home </a>|<a href="signout.php">Signout</a></strong></div>
...
switch($_REQUEST['page'])
{
 ...
 ?>
   ...
   <div class="row" style="float:right; margin-top:-250px;"><br><br><br><br>
...
<form method="post" onSubmit="return check();">
			...
			<input type="text"  name="editor2" placeholder="Video Link ...." style="height:50px;width:370px;" value="<?php echo $text1; ?>"><br /><br><br>
			...
			<input type="submit" value="submit" name="submit" class="submit" style="height:40px; width:70px; font-size:20px; margin-left:130px;" ></p>
        </form>
</div>
</div>
</body>
